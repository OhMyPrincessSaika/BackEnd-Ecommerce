...
const {createProduct,updateProduct,uploadProductImages,getProduct,getAllProducts,deleteProduct, rateAProduct, addToWishLists, addToCart, getUserCart, removeFromCart, removeFromWishlist} = require('../controllers/Product_Controller');
